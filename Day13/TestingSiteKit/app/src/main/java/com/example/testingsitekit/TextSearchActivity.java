...
public class TextSearchActivity extends AppCompatActivity {
    ...
    private void execTextSearch() {
        ...
        // take latitude longitude if exists
        Double lat;
        Double lng;
        ...
        // choose which country => eg. if myanmar, the results will be places in myanmar
        ...
        // how many pages for the results
        ...
        // how many places will be included in each page
        ...
        SearchResultListener<TextSearchResponse> resultListener = new SearchResultListener<TextSearchResponse>() {
            ...
            public void onSearchResult(TextSearchResponse results) {
                ...
                Log.d("RESULTS (Site):", siteList.toString());
                ...
                for (Site site : siteList) {
                    ...
                    String strAddr = String.format("country:%s\nstreetNumber:%s\ncountryCode:%s\ntertiaryAdminArea:%s\npostalCode:%s" +
                                    "\nlocality:%s\nsubLocality:%s\nadminArea:%s\nsubAdminArea:%s\nthoroughfare:%s\n", addressDetail.country,
                            addressDetail.streetNumber, addressDetail.countryCode, addressDetail.tertiaryAdminArea,
                            addressDetail.postalCode, addressDetail.locality, addressDetail.subLocality, addressDetail.adminArea,
                            addressDetail.subAdminArea, addressDetail.thoroughfare);
                    Log.d("RESULTS(addressDetail):", strAddr);
                    location = site.getLocation();
                    Log.d("RESULTS(Location):", addressDetail.toString());
                    poi = site.getPoi();
                    Log.d("RESULTS(poi):", addressDetail.toString());
                    viewport = site.getViewport();
                    Log.d("RESULTS(viewPort):", addressDetail.toString());
