...
package com.hkz.testingmapkit;

import static com.hkz.testingmapkit.utils.CheckUtils.checkIsEdit;
import static com.hkz.testingmapkit.utils.CheckUtils.checkIsRight;

import java.util.ArrayList;
import java.util.List;

import com.hkz.testingmapkit.utils.CheckUtils;
...
import com.hkz.testingmapkit.utils.MapUtils;
...
public class PolylineDemoActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        points.add(new LatLng(12.1231,21.4144));
    }
    ...
    public void addPolyline(View view) {
        ...
        mPolyline = hMap.addPolyline(
                new PolylineOptions().add(new LatLng(2.1233,23.3221),new LatLng(12.31121,31.123321)).color(Color.RED).width(2));
