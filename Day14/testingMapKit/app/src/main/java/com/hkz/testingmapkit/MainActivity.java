...
import com.hkz.testingmapkit.R;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button GroundOverlayDemo = findViewById(R.id.GroudOverlayDemo);
        Button LiteModeDemo = findViewById(R.id.LiteModeDemo);
        Button MoreLanguageDemo = findViewById(R.id.MoreLanguageDemo);
        Button MapFunctions = findViewById(R.id.MapFunctions);
        ...
        GroundOverlayDemo.setOnClickListener(this);
        LiteModeDemo.setOnClickListener(this);
        MoreLanguageDemo.setOnClickListener(this);
        MapFunctions.setOnClickListener(this);
